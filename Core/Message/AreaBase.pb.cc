...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 20, -1, sizeof(::message::DiagnosisListPush)},
  { 30, -1, sizeof(::message::DoctorRoomIDPush)},
  { 37, -1, sizeof(::message::UserPasswordModifyRequest)},
  { 46, -1, sizeof(::message::UserPasswordModifyResponse)},
  { 54, -1, sizeof(::message::UserAvatarModifyRequest)},
  { 62, -1, sizeof(::message::UserAvatarModifyResponse)},
};
...
const char descriptor_table_protodef_AreaBase_2eproto[] =
  ...
  "uest\022\022\n\npublic_key\030\001 \001(\t\"\262\001\n\014ListPropert"
  ...
  "\t \001(\021\"\330\001\n\021DiagnosisListPush\022)\n\nwait_forc"
  "e\030\001 \003(\0132\025.message.ListProperty\022#\n\004wait\030\002"
  " \003(\0132\025.message.ListProperty\022$\n\005pass_\030\003 \003"
  "(\0132\025.message.ListProperty\022$\n\005pause\030\004 \003(\013"
  "2\025.message.ListProperty\022\'\n\010complete\030\005 \003("
  "\0132\025.message.ListProperty\"6\n\020DoctorRoomID"
  "Push\022\017\n\007room_id\030\001 \001(\021\022\021\n\tdoctor_id\030\002 \001(\t"
  "\"a\n\031UserPasswordModifyRequest\022\017\n\007user_id"
  "\030\001 \001(\t\022\021\n\tuser_type\030\002 \001(\t\022\017\n\007pwd_old\030\003 \001"
  "(\t\022\017\n\007pwd_new\030\004 \001(\t\"M\n\032UserPasswordModif"
  "yResponse\022\017\n\007user_id\030\001 \001(\t\022\016\n\006result\030\002 \001"
  "(\010\022\016\n\006reason\030\003 \001(\t\"M\n\027UserAvatarModifyRe"
  "quest\022\017\n\007user_id\030\001 \001(\t\022\021\n\tuser_type\030\002 \001("
  "\t\022\016\n\006avatar\030\003 \001(\014\"K\n\030UserAvatarModifyRes"
...
static ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_AreaBase_2eproto = {
  ...
  "AreaBase.proto", &assign_descriptors_table_AreaBase_2eproto, 862,
};
...
const char* DoctorRoomIDPush::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        if (static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) != 8) goto handle_unusual;
        set_room_id(::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr));
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
      // string doctor_id = 2;
...
void DoctorRoomIDPush::SerializeWithCachedSizes(
  ...
  // sint32 room_id = 1;
  if (this->room_id() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32(1, this->room_id(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* DoctorRoomIDPush::InternalSerializeWithCachedSizesToArray(
  ...
  // sint32 room_id = 1;
  if (this->room_id() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32ToArray(1, this->room_id(), target);
  }

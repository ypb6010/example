...
"}"));
        ...
        labIcon->setStyleSheet(QStringLiteral(""));
...
"}"));
    ...
    void retranslateUi(QWidget *TitleBar)
    {
        ...
        tileText->setText(QApplication::translate("TitleBar", "\350\277\234\347\250\213\344\270\223\345\256\266\345\267\245\344\275\234\347\253\231", nullptr));

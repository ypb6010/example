...
"{			\n"
"	border-i"
                        "mage: url(:/res/leftExpand/leave_normal.png);\n"
"	border-radius: 4px;\n"
"	font-family: MicrosoftYaHei;\n"
"	font-size: 24px;\n"
"	line-height: 20px;\n"
"	color: #ffffff;\n"
"}\n"
"QToolButton#leaveService:hover:checked\n"
"{			\n"
...
"}"));
        ...
        curName = new QLabel(displayWidget);
        curName->setObjectName(QStringLiteral("curName"));
        curName->setMinimumSize(QSize(80, 20));
        curName->setMaximumSize(QSize(16777215, 16777215));
        curName->setStyleSheet(QLatin1String("QLabel#curName\n"
"{\n"
"	font-family: MicrosoftYaHei;\n"
"	font-size: 26px;\n"
"	line-height: 23.79px;\n"
"	color: #ffffff;\n"
"}"));
        curName->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);

        gridLayout->addWidget(curName, 2, 1, 1, 1);

        horizontalSpacer = new QSpacerItem(38, 20, QSizePolicy::Preferred, QSizePolicy::Minimum);
...
"}"));
        ...
        horizontalSpacer_2 = new QSpacerItem(92, 20, QSizePolicy::Preferred, QSizePolicy::Minimum);
...
"	color: #ffffff;\n"
"}"));
        nextNameLab->setScaledContents(true);
...
""));
    ...
    void retranslateUi(QWidget *LeftExpandWidget)
    {
        ...
        label_11->setText(QApplication::translate("LeftExpandWidget", "\345\212\251\350\257\212\345\214\273\347\224\237\345\267\245\344\275\234\347\253\231", nullptr));
        ...
        curName->setText(QApplication::translate("LeftExpandWidget", "--", nullptr));

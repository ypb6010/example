...
QT_MOC_LITERAL(1, 14, 14), // "addDrugClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14), // "addPastClecked"
QT_MOC_LITERAL(4, 45, 16), // "addFamilyClicked"
QT_MOC_LITERAL(5, 62, 17) // "addGeneticClicked"

    },
    "HistoryDialog\0addDrugClicked\0\0"
    "addPastClecked\0addFamilyClicked\0"
    "addGeneticClicked"
};
...
void HistoryDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addDrugClicked(); break;
        case 1: _t->addPastClecked(); break;
        case 2: _t->addFamilyClicked(); break;
        case 3: _t->addGeneticClicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryDialog::addDrugClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HistoryDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryDialog::addPastClecked)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (HistoryDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryDialog::addFamilyClicked)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (HistoryDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HistoryDialog::addGeneticClicked)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HistoryDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_HistoryDialog.data,
      qt_meta_data_HistoryDialog,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void HistoryDialog::addDrugClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void HistoryDialog::addPastClecked()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void HistoryDialog::addFamilyClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void HistoryDialog::addGeneticClicked()
{

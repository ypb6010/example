...
"}"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/Resources/addOffLine.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        drugView->setFrameShape(QFrame::StyledPanel);
        drugView->setFrameShadow(QFrame::Sunken);
...
"}"));
        ...
        sizePolicy.setHeightForWidth(pastView->sizePolicy().hasHeightForWidth());
        pastView->setSizePolicy(sizePolicy);
        pastView->setMinimumSize(QSize(530, 200));
        pastView->setMaximumSize(QSize(2550, 2550));
...
"\n"
""));
        pastView->setSelectionMode(QAbstractItemView::SingleSelection);
        pastView->setSelectionBehavior(QAbstractItemView::SelectRows);
        pastView->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
